...
no_data — в посте нет ничего, кроме должности и ссылки: ни языка, ни стека, \
ни задач. Судить не по чему. Это НЕ medium: medium значит "язык подходит, но \
есть расхождение", а тут неизвестен сам язык. И это НЕ low: low — это \
"проверили и мимо", а здесь мы ничего не проверили. Ставь no_data ТОЛЬКО когда \
в посте реально нечего читать; если язык или задачи названы — оценивай обычной \
шкалой.
